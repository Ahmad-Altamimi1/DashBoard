...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submitAdd'])) {
        ...
        $crudObj->addProduct($name, $product_price, $product_brife, $product_des, $id, $quantity_product, $uploadFile, $mainfactor);
        header("Location: products.php?category_id=");
        exit();
    }
    ?>
        ...
        <div class="container">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class=" mb-3 form">
                    ...
                    <input class="form-control" type="text" id="mainfactor" name="mainfactor">
                </div>
